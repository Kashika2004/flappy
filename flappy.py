...
# Global Variables for the game ..kuch aise variable jo hum throughout the game banana chaehnge
FPS = 32 #FPS=frame per second, 1 sec main kitne image render ho rhe
SCREENWIDTH = 289 
SCREENHEIGHT = 511
SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT)) #it makes display service in pygame
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = ( 
        pygame.image.load('gallery/sprites/0.png').convert_alpha(),   #alpha used for faster rendering of images on screem
